...
interface CoreRecipientsTestProps {
  addresses: string[]
  onChange: (addresses: string[]) => void
  maxRecipients: number
}

export default function CoreRecipientsTest({addresses, onChange, maxRecipients}: CoreRecipientsTestProps): React.JSX.Element {
  return (
