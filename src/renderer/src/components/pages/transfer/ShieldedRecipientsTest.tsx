...
interface ShieldedRecipientsTestProps {
  addresses: string[]
  onChange: (addresses: string[]) => void
  maxRecipients: number
}

export default function ShieldedRecipientsTest({addresses, onChange, maxRecipients}: ShieldedRecipientsTestProps): React.JSX.Element {
  return (
