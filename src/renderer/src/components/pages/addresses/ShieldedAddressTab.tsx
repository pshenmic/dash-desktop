  ...
  if (address !== null) {
    return (
      <div className={"flex flex-col gap-[.625rem]"}>
        <div className={"flex items-center justify-between gap-4 px-[.9375rem] py-[.625rem] rounded-[.875rem] dash-block"}>
        ...
        <Text size={12} weight={"medium"} color={"brand"} opacity={50} className={"px-1 leading-[130%]"}>
          Your Orchard shielded address. Share it to receive private funds — incoming payments reveal nothing about sender, recipient or amount on-chain.
        </Text>
      </div>
    )
  }
