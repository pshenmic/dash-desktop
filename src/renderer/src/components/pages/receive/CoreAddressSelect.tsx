        ...
        {selected ? (
          <div className={"flex items-center gap-2.5 min-w-0"}>
            ...
            <div className={"flex flex-col items-start min-w-0"}>
              <Text size={14} weight={"medium"} color={"brand"} className={"font-mono break-all text-left"}>{selected.address}</Text>
          ...
          {addresses.map(a => (
            ...
            >
              ...
              <div className={"flex flex-col min-w-0"}>
                <Text size={14} weight={"medium"} color={"brand"} className={"font-mono break-all text-left"}>{a.address}</Text>
