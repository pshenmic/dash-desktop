...
export function identityRegistrationMaxDuffs(balanceDuffs: bigint, coreFeeDuffs: bigint): bigint {
  return balanceDuffs > coreFeeDuffs ? balanceDuffs - coreFeeDuffs : 0n
}
...
export function identityRegistrationAmountError(
  ...
  const maxDuffs = identityRegistrationMaxDuffs(balanceDuffs, coreFeeDuffs)
