...
interface OperationInfo {
  ...
  coreFeeShape: CoreFeeShape | null
}

const OPERATION_INFO: Record<TransferOperation, OperationInfo> = {
  [TransferOperation.CoreSend]: {title: 'Send Dash', submitLabel: 'Send', unit: 'dash', minCredits: null, spendKind: null, coreFeeShape: CoreFeeShape.Send},
  [TransferOperation.AssetLockFunding]: {title: 'Fund Platform address', submitLabel: 'Fund', unit: 'dash', minCredits: null, spendKind: null, coreFeeShape: CoreFeeShape.AssetLock},
  [TransferOperation.AssetLockShield]: {title: 'Shield from L1', submitLabel: 'Shield', unit: 'dash', minCredits: null, spendKind: null, coreFeeShape: CoreFeeShape.AssetLock},
  [TransferOperation.IdentityRegister]: {title: 'Register identity', submitLabel: 'Register', unit: 'dash', minCredits: null, spendKind: null, coreFeeShape: CoreFeeShape.AssetLock},
  [TransferOperation.IdentityTopUpL1]: {title: 'Top up identity from L1', submitLabel: 'Top up', unit: 'dash', minCredits: null, spendKind: null, coreFeeShape: CoreFeeShape.AssetLock},
  [TransferOperation.AddressFundsTransfer]: {title: 'Transfer credits', submitLabel: 'Send', unit: 'credits', minCredits: 500_000n, spendKind: null, coreFeeShape: null},
  [TransferOperation.IdentityTopUp]: {title: 'Top up identity', submitLabel: 'Top up', unit: 'credits', minCredits: 100_000n, spendKind: null, coreFeeShape: null},
  [TransferOperation.IdentityCreate]: {title: 'Create identity', submitLabel: 'Create', unit: 'credits', minCredits: 500_000n, spendKind: null, coreFeeShape: null},
  [TransferOperation.AddressWithdrawal]: {title: 'Withdraw to Core', submitLabel: 'Withdraw', unit: 'credits', minCredits: 100_000n, spendKind: null, coreFeeShape: null},
  [TransferOperation.Shield]: {title: 'Shield credits', submitLabel: 'Shield', unit: 'credits', minCredits: 500_000n, spendKind: null, coreFeeShape: null},
  [TransferOperation.IdentityToAddress]: {title: 'Send from identity', submitLabel: 'Send', unit: 'credits', minCredits: 500_000n, spendKind: null, coreFeeShape: null},
  [TransferOperation.IdentityToIdentity]: {title: 'Send to identity', submitLabel: 'Send', unit: 'credits', minCredits: 100_000n, spendKind: null, coreFeeShape: null},
  [TransferOperation.IdentityWithdrawal]: {title: 'Withdraw from identity', submitLabel: 'Withdraw', unit: 'credits', minCredits: 100_000n, spendKind: null, coreFeeShape: null},
  [TransferOperation.ShieldedTransfer]: {title: 'Shielded send', submitLabel: 'Send', unit: 'credits', minCredits: 500_000n, spendKind: ShieldedSpendKind.Transfer, coreFeeShape: null},
  [TransferOperation.Unshield]: {title: 'Unshield', submitLabel: 'Unshield', unit: 'credits', minCredits: 500_000n, spendKind: ShieldedSpendKind.Unshield, coreFeeShape: null},
  [TransferOperation.ShieldedWithdrawal]: {title: 'Withdraw to L1', submitLabel: 'Withdraw', unit: 'credits', minCredits: 500_000n, spendKind: ShieldedSpendKind.Withdrawal, coreFeeShape: null},
  [TransferOperation.IdentityCreateFromPool]: {title: 'Create identity from pool', submitLabel: 'Create', unit: 'credits', minCredits: 10_000_000_000n, spendKind: ShieldedSpendKind.IdentityCreate, coreFeeShape: null},
}
