export const apiDefinitions = (ipcRenderer) => ({
  ...
  startShieldedUnshield: (walletId: string, outputAddress: string, amountCredits: string, password: string, noteIndexes?: number[]) => ipcRenderer.invoke('startShieldedUnshield', walletId, outputAddress, amountCredits, password, noteIndexes),
  startShieldedWithdrawal: (walletId: string, coreAddress: string, amountCredits: string, password: string, noteIndexes?: number[]) => ipcRenderer.invoke('startShieldedWithdrawal', walletId, coreAddress, amountCredits, password, noteIndexes),
