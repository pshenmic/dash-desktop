...
// identity picked, no amount typed. maxDuffs is the largest amount the L1
// selection can fund, which is not the balance minus feeDuffs: the fee grows
// with every input it takes. maxPerTx and noteLimit are pool-spend facts:
// nothing else is capped by anything but the balance.
