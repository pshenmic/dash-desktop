...
import * as migration0007 from '../../migrations/0007_shielded_notes'
...
import * as migration0020 from '../../migrations/0020_contact_kind'
...
const migrations = [
  ...
  { name: '0007_shielded_notes.ts', migration: migration0007 },
  ...
  { name: '0020_contact_kind.ts', migration: migration0020 },
]
